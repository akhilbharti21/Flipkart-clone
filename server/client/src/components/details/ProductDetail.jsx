...
const ProductDetail = ({ product }) => {
    ...
    return (
        <>
            ...
            <SmallText>
                <Typography><StyledBadge />Get extre 20% off upto ₹50 on 1 item(s) T&C </Typography>
                <Typography><StyledBadge />Get extre 13% off (price inclusive of discount) T&C </Typography>
                ...
                <Typography><StyledBadge />No Cost EMI Bajaj Finserv EMI Card on cart value above ₹2999 T&C</Typography>
